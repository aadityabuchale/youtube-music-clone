...
const iconStyles = {
    ...
    // Add specific styles for individual icons if needed
};
...
const SignInIcon = (props) => (
    <svg
        ...
        style={props.style || iconStyles.common}
        fill="grey"
    >
        <path
            d="M3,3v18h18V3H3z M4.99,20c0.39-2.62,2.38-5.1,7.01-5.1s6.62,2.48,7.01,5.10H4.99z M9,10c0-1.65,1.35-3,3-3s3,1.35,3,3c0,1.65-1.35,3-3,3S9,11.65,9,10z M12.72,13.93C14.58,13.59,16,11.96,16,10c0-2.21-1.79-4-4-4c-2.21,0-4,1.79-4,4c0,1.96,1.42,3.59,3.28,3.93c-4.42,0.25-6.84,2.80-7.28,6V4h16v15.93C19.56,16.73,17.14,14.18,12.72,13.93z"
            className="style-scope yt-icon"
        ></path>
    </svg>
);

const MusicPremiumIcon = (props) => (
    <svg
        viewBox="0 0 24 24"
        preserveAspectRatio="xMidYMid meet"
        focusable="false"
...
const TermsPrivacyIcon = (props) => (
    <svg
        ...
        fill="grey"
    >
        <path d="M15.36,9.96c0,1.09-0.67,1.67-1.31,2.24c-0.53,0.47-1.03,0.90-1.16,1.6L12.85,14h-1.75l0.03-0.28c0.14-1.17,0.80-1.76,1.47-2.27c0.52-0.4,1.01-0.77,1.01-1.49c0-0.51-0.23-0.97-0.63-1.29c-0.40-0.31-0.92-0.42-1.42-0.29c-0.59,0.15-1.05,0.67-1.19,1.34L10.32,10H8.57l0.06-0.42c0.2-1.4,1.15-2.53,2.42-2.87c1.05-0.29,2.14-0.08,2.98,0.57C14.88,7.92,15.36,8.90,15.36,9.96z M12,18c0.55,0,1-0.45,1-1s-0.45-1-1-1s-1,0.45-1,1S11.45,18,12,18z M12,3c-4.96,0-9,4.04-9,9s4.04,9,9,9s9-4.04,9-9S16.96,3,12,3 M12,2c5.52,0,10,4.48,10,10s-4.48,10-10,10S2,17.52,2,12S6.48,2,12,2L12,2z" />
    </svg>
);
